...
import br.com.simon.gestao_vagas.modules.candidate.dto.ProfileCandidateResponseDTO;
import br.com.simon.gestao_vagas.modules.candidate.useCases.ApplyJobCandidateUseCase;
import br.com.simon.gestao_vagas.modules.candidate.useCases.CreateCandidateUseCase;
import br.com.simon.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
import br.com.simon.gestao_vagas.modules.candidate.useCases.ProfileCandidateUseCase;
import br.com.simon.gestao_vagas.modules.company.entities.JobEntity;
...
public class CandidateController {
  ...
  @Operation(summary = "Perfil do candidato", description = "Esta função é responsavel por buscar as informações do perfil do candidato")
  @ApiResponses({
      @ApiResponse(responseCode = "200", content = {
  ...
  public ResponseEntity<Object> get(HttpServletRequest request) {
    ...
    try {
      ...
      System.out.println("  PROFILE VINDO " + profile);
  ...
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Inscrição do candidato para uma vaga", description = "Função responsavel por realizar a inscrição do candidato em uma vaga")
  @SecurityRequirement(name = "jwt_auth")
